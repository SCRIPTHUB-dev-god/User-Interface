...
function library:window(options)
    ...
    function window:SetToggleUi(cfg)
        ...
        -- drag icon selalu pake move dari iconMap
        ...
        -- buat gambar lagi sebelum text bukan sebelum garis (untuk penaroan icon di api)
        ...
        -- geometri kotak size xy masih sama + corner
        ToggleUI.Size = UDim2.new(0, 135, 0, 36)
        ...
        -- garis tetap tapi setelah drag icon
    ...
    local function buatElementMethods(containerFrame)
        ...
        function methods:AddParagraph(pOptions)
            ...
            local function createParaButton(bCfg, isInContainer)
                ...
                -- stroke sama seperti stroke main ui (2.5)
            ...
            local function createDoubleTripleButtons(btnList)
                ...
                -- kalau lebih dari 3, cuma 3 saja yang muncul dengan x dikurangi supaya muat
                if #btnList > 3 then
                    local limited = {}
                    for i=1,3 do
                ...
                layout.Padding = UDim.new(0, 6)
                local count = #btnList
                -- x dikurangi supaya muat untuk 3 button
                for _, bCfg in ipairs(btnList) do
                    ...
                    bFrame.ClipsDescendants = false
                    Instance.new("UICorner", bFrame).CornerRadius = UDim.new(0, 6)
                    -- stroke sama seperti stroke main ui
                    local bStroke = Instance.new("UIStroke", bFrame)
                    bStroke.Color = currentTheme.Stroke
                    bStroke.Thickness = 2.5
                    bStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
            ...
            elseif buttonData then
                -- single button tanpa button lain - pastikan stroke ada (sama seperti main ui)
